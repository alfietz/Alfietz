...
const emit = defineEmits(['go-back', 'go-help', 'go-privacy', 'go-terms', 'go-about', 'go-feedback', 'update:language', 'update:role', 'logout', 'toggle-theme'])
    ...
    <div class="settings-container">
      ...
      <div class="settings-column">
        ...
        <section class="settings-card">
          ...
          <div class="list-item tap-active" @click="handleAction(() => $emit('toggle-theme'))">
            <div class="item-lead">
              <svg v-if="userData.theme === 'dark'" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--accent-amber)" stroke-width="2"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>
              <svg v-else width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--accent-amber)" stroke-width="2"><circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/></svg>
              <span>{{ userData.theme === 'dark' ? 'Dark Mode' : 'Light Mode' }}</span>
            </div>
            <div class="custom-toggle" :class="{ on: userData.theme === 'dark' }">
